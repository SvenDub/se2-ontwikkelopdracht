...
CREATE TABLE FILM (
  ...
  SEQUEL_TO INT REFERENCES FILM (FILM_ID)
);

CREATE TABLE FILM_CREW_MAP (
  FILM_ID INT REFERENCES FILM (FILM_ID),
  CREW_ID INT REFERENCES CREW (CREW_ID),
  TYPE_ID INT REFERENCES CREW_TYPE (TYPE_ID),
  CONSTRAINT PK_FILM_CREW_MAP PRIMARY KEY (FILM_ID, CREW_ID, TYPE_ID)
);
...
CREATE TABLE FILM_KIJKWIJZER_MAP (
  FILM_ID INT REFERENCES FILM (FILM_ID),
  KIJKWIJZER_ID INT REFERENCES KIJKWIJZER_ITEM (KIJKWIJZER_ID),
...
CREATE TABLE MEDIA_ITEM_SUGGESTION (
  FIRST_ITEM_ID INT REFERENCES MEDIA_ITEM (ITEM_ID),
  SECOND_ITEM_ID INT REFERENCES MEDIA_ITEM (ITEM_ID),
...
CREATE TABLE ZAAL (
  ...
  NUMMER INT NOT NULL,
  BIOSCOOP_ID INT NOT NULL REFERENCES BIOSCOOP (BIOSCOOP_ID)
);  
...
CREATE TABLE STOEL (
  ...
  NUMMER INT NOT NULL,
  RIJ INT NOT NULL,
  ZAAL_ID INT NOT NULL REFERENCES ZAAL (ZAAL_ID)
);
...
CREATE TABLE KORTINGSKAART (
  ...
  USER_ID INT NOT NULL REFERENCES GEBRUIKER (USER_ID),
  BEDRAG INT NOT NULL
);
...
CREATE TABLE KORTINGSKAART_UITGAVE (
  BESTELNR INT REFERENCES BESTELLING (BESTELNR),
  KAARTNR INT REFERENCES KORTINGSKAART (KAARTNR),
  BEDRAG INT NOT NULL,
...
CREATE TABLE KAARTJE (
  ...
  VOORSTELLING_ID INT REFERENCES VOORSTELLING (VOORSTELLING_ID),
  STOEL_ID INT REFERENCES STOEL (STOEL_ID),
  BESTELLING_ID INT NOT NULL REFERENCES BESTELLING (BESTELNR),
...
insert into VOORSTELLING (VOORSTELLING_ID, FILM_ID, ZAAL_ID, DATUM) values (1, 1, 1, '2016-04-10');
insert into VOORSTELLING (VOORSTELLING_ID, FILM_ID, ZAAL_ID, DATUM) values (2, 1, 2, '2016-04-10');
insert into VOORSTELLING (VOORSTELLING_ID, FILM_ID, ZAAL_ID, DATUM) values (3, 2, 1, '2016-04-11');
insert into VOORSTELLING (VOORSTELLING_ID, FILM_ID, ZAAL_ID, DATUM) values (4, 2, 7, '2016-04-10');
insert into VOORSTELLING (VOORSTELLING_ID, FILM_ID, ZAAL_ID, DATUM) values (5, 1, 8, '2016-04-11');
insert into VOORSTELLING (VOORSTELLING_ID, FILM_ID, ZAAL_ID, DATUM) values (6, 1, 9, '2016-04-10');
insert into VOORSTELLING (VOORSTELLING_ID, FILM_ID, ZAAL_ID, EVENT_ID, DATUM) values (7, 1, 5, 1, '2016-04-10');
insert into VOORSTELLING (VOORSTELLING_ID, FILM_ID, ZAAL_ID, EVENT_ID, DATUM) values (8, 2, 5, 1, '2016-04-10');
insert into VOORSTELLING (VOORSTELLING_ID, FILM_ID, ZAAL_ID, EVENT_ID, DATUM) values (9, 2, 2, 2, '2016-05-01');
insert into VOORSTELLING (VOORSTELLING_ID, FILM_ID, ZAAL_ID, EVENT_ID, DATUM) values (10, 3, 2, 2, '2016-05-02');
